...
ce_name = "hermes-process-email-act-kitcode-compute-env-dr"
ce_cr_max_vcpus = 2
...
jq_name = "hermes-process-email-act-kitcode-job-queue-dr"

jd_name = "hermes-process-email-act-kitcode-job-definition-dr"
jd_timeout = 600
...
schedule_name = "hermes-process-email-act-kitcode-schedule-dr"
schedule_target_role_arn = "arn:aws:iam::214946096060:role/hermes-ecs-task-execution-role-dr"
schedule_job_name = "Hermes-Process-Email-Act-Kitcode-Job-DR"