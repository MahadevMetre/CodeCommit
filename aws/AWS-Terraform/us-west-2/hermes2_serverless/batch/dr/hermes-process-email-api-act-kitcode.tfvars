...
ce_name = "hermes-process-email-api-act-kitcode-compute-env-dr"
ce_cr_max_vcpus = 2
...
jq_name = "hermes-process-email-api-act-kitcode-job-queue-dr"

jd_name = "hermes-process-email-api-act-kitcode-job-definition-dr"
jd_timeout = 1200
...
schedule_name = "hermes-process-email-api-act-kitcode-schedule-dr"
schedule_target_role_arn = "arn:aws:iam::214946096060:role/hermes-ecs-task-execution-role-dr"
schedule_job_name = "Hermes-Process-Email-API-Act-Kitcode-Job-DR"