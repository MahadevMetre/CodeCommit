alb_sg_name					= "fmg-ecs-sg-alb-dr"
alb_sg_description			= "Security group to allow inbound to alb"
alb_sg_vpc_id				= "vpc-0e79e26eb537504d0"
alb_sg_tags = {
...
alb_sg_ingress_rules = {
	"1" = {
		...
		description			= "HTTPS From Private Subnets DR"
	},
	"2" = {
		from_port			= 443
		to_port				= 443
...
tg2_name							= "pycharm-webservices-tg-dr"
tg2_health_check_port				= 80
tg2_protocol						= "HTTP"
tg2_vpc_id							= "vpc-0e79e26eb537504d0"
...
tg3_name							= "fmg-serverless-email-tg-dr"
tg3_health_check_port				= 8080
tg3_protocol						= "HTTP"
tg3_vpc_id							= "vpc-0e79e26eb537504d0"
...
lbl_certificate_arn					= "arn:aws:acm:us-west-2:214946096060:certificate/ad1f6503-3618-44e1-860a-8354397a4bf0"
lbl_health_check_port				= 443
lbl_protocol						= "HTTPS"
lbl_default_action_type				= "forward"
lbl_ssl_policy						= "ELBSecurityPolicy-TLS13-1-2-2021-06"

route53_zone_id				= "Z00624956N47Z2N3AN6I"
route53_name				= "dr-ecs.mtservices.franklinmadisonds.com"
route53_type				= "CNAME"