...
variable "token_url" {
  description = "The token URL for the OAuth application."
  type        = string
  default     = ""
}
...
variable "region" {
  description = "The AWS region to use for the API Gateway and Lambda."
  type        = string
  default     = ""
}

variable "marketing_lambda_warm_schedules" {
  type    = bool
  default = false
}
