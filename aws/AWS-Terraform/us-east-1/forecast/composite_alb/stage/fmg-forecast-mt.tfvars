alb_sg_name					= "fmg-forecast-sg-stage"
...
alb_sg_ingress_rules = {
	...
	"9" = {
		...
		description			= "HTTPS From stage to QA"
	},
	"10" = {
		from_port			= 22
		to_port				= 22
		protocol			= "tcp"
		cidr_blocks			= ["10.153.16.0/22"]
		description			= "SSH From Stage to QA"
	}
}

lb_name						= "fmg-forecast-alb-stage"
lb_type						= "application"
lb_tags = {
    "ApplicationName"		= "InsuranceApps"
	"Automated"				= "True"
...
lbl_certificate_arn					= "arn:aws:acm:us-east-1:702230634984:certificate/564cba61-7927-48c8-83f9-44befef3e963"
...
route53_name				= "stage-forecast-mt.franklinmadisonds.com"
route53_type				= "CNAME"