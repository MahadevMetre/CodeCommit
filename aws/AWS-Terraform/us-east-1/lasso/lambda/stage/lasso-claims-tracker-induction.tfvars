lambda_function_name = "lasso-claims-tracker-induction-stage"
role = "arn:aws:iam::702230634984:role/lasso-lambda-role-stage"
description = "Lasso Claims Tracker Induction Stage"
env_variables = {
		...
		"LASSO_ATLAS_INTEGRATION_LAMBDA"		=	"lasso-atlas-integration-stage"
		...
		"S3_LASSO_BATCH_BUCKET_NAME"			=	"lasso-batch-files-stage"
		"S3_LASSO_BOCK_SERVER_BUCKET"			=	"insclaimsbockserver-stage"
		"S3_LASSO_SCANNED_BUCKET_NAME"			=	"lasso-scanned-files-stage"
...
s3_bucket_statement_id = "event_permissions_for_bucket_lasso-claims-tracker-files-stage"
s3_bucket_account_id = "702230634984"
s3_bucket_arn = "arn:aws:s3:::lasso-claims-tracker-files-stage"