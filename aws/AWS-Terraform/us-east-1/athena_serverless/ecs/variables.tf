...
variable "cloudwatch_log_group_name5" {
  type = string
}

variable "cloudwatch_log_group_retention5" {}

variable "cloudwatch_log_group_tags5" {
  type = map
  default = {
    "terraform" = "True"
  }
...
variable "task_definition_family5" {}

variable "container_definition_name5" {}

variable "container_definition_image5" {}

variable "cd_portmapping_containerport5" {}

variable "cd_portmapping_hostport5" {}

variable "cd_portmapping_protocol5" {}

variable "cd_env_vars5" {
	type = list(map(string))
	default = []
}

variable "cd_mount_points5" {
	default = []
}

variable "task_definition_cpu5" {}

variable "task_definition_memory5" {}

variable "td_execution_role_arn5" {
	default = ""
}

variable "td_task_role_arn5" {
	default = ""
}

variable "td_volumes5" {
	type = map
	default = {}
}

variable "td_volume_name5" {
	default = ""
}

variable "td_volume_fs_id5" {
	default = ""
}

variable "td_volume_root_dir5" {
	default = ""
}
...
variable "service_name5" {}

variable "service_subnets5" {
  type = list(string)
  default = []
}

variable "service_sg5" {
  type = list(string)
  default = []
}

variable "service_tg_arn5" {}
