...
variable "tg5_health_check_port" {}

variable "port5" {}

variable "tg5_protocol" {}

variable "tg5_vpc_id" {}

variable "tg5_protocol_version" {}

variable "tg5_deregistration_delay" {}

variable "tg5_healthy_threshold" {}

variable "tg5_interval" {}

variable "tg5_unhealthy_threshold" {}

variable "tg5_health_check_timeout" {}

variable "tg5_load_balancing_algorithm_type" {}

variable "tg5_health_check_protocol" {}

variable "tg5_target_type" {}

variable "tg5_health_check_path" {}
...
variable "lbr5_priority" {}

variable "lbr5_action_type" {}

variable "lbr5_path_pattern" {}
