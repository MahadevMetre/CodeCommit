lambda_function_name = "marketing-matchbackenroll-qa"
role = "arn:aws:iam::634621569833:role/digital-lambda-docker-role-qa"
description = "marketing lambda for matchback-enroll"
env_variables = {
...
publish = false
image_uri = "634621569833.dkr.ecr.us-east-1.amazonaws.com/fmg-digital:marketing-matchbackenroll-qa"
attach_apigw_permission = true
apigw_arn = ["arn:aws:execute-api:us-east-1:634621569833:ek92om56yd/*/POST/marketing/matchBackEnroll"]