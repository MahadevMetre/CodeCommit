lambda_function_name = "marketing-validate-accesscode-pci"
role = "arn:aws:iam::601751840347:role/digital-lambda-docker-role-pci"
description = "marketing lambda for validate-accescode"
env_variables = {
...
publish = false
image_uri = "601751840347.dkr.ecr.us-east-1.amazonaws.com/fmg-digital:marketing-validate-accesscode-pci"
