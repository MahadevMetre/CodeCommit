config_set_name = "digital-email-tracking-qa"
config_set_tags = {
...
event_dest_name = "digital-email-tracking-firehose-qa"
event_types = ["CLICK", "DELIVERY", "OPEN", "SEND"]

log_group_name = "/aws/kinesisfirehose/PUT-digital-email-tracking-qa"
log_retention_days = "30"

bucket_short_name = "digital-email-tracking"
environment = "qa"
logging_bucket_name = "franklin-alb-access-logs-qa"
logging_bucket_base_prefix = "digital-email-tracking-qa"
acl = "private"
s3b_tags ={
    "ApplicationName"		= "Digital"
	"Automated"				= "True"
...
fs_stream_name = "PUT-digital-email-tracking-qa"
...
role_name		= "digital-email-tracking-role-qa"
...
iam_policy_name					= "digital-email-tracking-policy-qa"
iam_policy_tags					= {
	"ApplicationName": "Digital",
	"Automated": "True",
	"BackupPlan": "None",
...
lambda_role = "arn:aws:iam::634621569833:role/fmg-dw-lambda-role-stage" 
