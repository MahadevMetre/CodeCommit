...
ce_name = "marketing-discard-paperles-compute-env-qa"
ce_cr_max_vcpus = 2
...
jq_name = "marketing-discard-paperles-job-queue-qa"

jd_name = "marketing-discard-paperles-job-definition-qa"
jd_timeout = 300
jd_container_command = ["discardpaperlessJob"]
jd_container_image = "634621569833.dkr.ecr.us-east-1.amazonaws.com/fmg-insuranceapps:marketing_discard_paperless_job-qa"  
...
schedule_job_name = "marketing-discard-paperles-job-definition-qa"