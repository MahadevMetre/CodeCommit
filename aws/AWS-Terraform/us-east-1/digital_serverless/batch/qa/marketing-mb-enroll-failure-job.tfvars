...
ce_name = "marketing-mb-enroll-failure-compute-env-qa"
ce_cr_max_vcpus = 2
...
jq_name = "marketing-mb-enroll-failure-job-queue-qa"

jd_name = "marketing-mb-enroll-failure-job-definition-qa"
 
jd_timeout = 300
jd_container_command = ["mbenrollemailfailureJob"]
jd_container_image = "634621569833.dkr.ecr.us-east-1.amazonaws.com/fmg-insuranceapps:marketing_mbenroll_failure_job-qa"  
...
schedule_job_name = "marketing-mb-enroll-failure-job-definition-qa"