...
ce_name = "marketing-mb-enroll-failure-compute-env-stage"
ce_cr_max_vcpus = 2
...
jq_name = "marketing-mb-enroll-failure-job-queue-stage"

jd_name = "marketing-mb-enroll-failure-job-definition-stage"
 
jd_timeout = 300
jd_container_command = ["mbenrollemailfailureJob"]
jd_container_image = "702230634984.dkr.ecr.us-east-1.amazonaws.com/fmg-insuranceapps:marketing_mbenroll_failure_job-stage"
...
marketing_mb_enroll_fail = true
schedule_target_role_arn = "arn:aws:iam::702230634984:role/digital-ecs-task-execution-role-stage"
schedule_job_name = "marketing-mb-enroll-failure-job-compute-env-stage"