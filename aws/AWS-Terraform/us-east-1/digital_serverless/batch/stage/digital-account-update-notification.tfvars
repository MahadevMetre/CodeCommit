...
ce_name = "digital-account-update-notification-stage"
ce_cr_max_vcpus = 2
...
jq_name = "digital-account-update-notification-job-queue-stage"

jd_name = "digital-account-update-notification-job-definition-stage"
jd_timeout = 300
jd_container_command = ["accountupdatenotificationJob"]
jd_container_image = "702230634984.dkr.ecr.us-east-1.amazonaws.com/fmg-insuranceapps:digital-batch-account-update-stage"
...
schedule_job_name = "digital-account-update-notification-job-definition-stage"