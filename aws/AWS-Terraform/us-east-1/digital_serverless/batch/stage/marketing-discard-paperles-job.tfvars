...
ce_name = "marketing-discard-paperles-compute-env-stage"
ce_cr_max_vcpus = 2
...
jq_name = "marketing-discard-paperles-job-queue-stage"

jd_name = "marketing-discard-paperles-job-definition-stage"
jd_timeout = 300
jd_container_command = ["discardpaperlessJob"]
jd_container_image = "702230634984.dkr.ecr.us-east-1.amazonaws.com/fmg-insuranceapps:marketing_discard_paperless_job-stage"
