...
ce_name = "marketing-discard-paperles-compute-env-pci"
ce_cr_max_vcpus = 2
...
jq_name = "marketing-discard-paperles-job-queue-pci"

jd_name = "marketing-discard-paperles-job-definition-pci"
jd_timeout = 600
jd_container_command = ["discardpaperlessJob"]
jd_container_image = "601751840347.dkr.ecr.us-east-1.amazonaws.com/fmg-insuranceapps:marketing_discard_paperless_job-pci"
...
schedule_job_name = "marketing-discard-paperles-schedule-pci"