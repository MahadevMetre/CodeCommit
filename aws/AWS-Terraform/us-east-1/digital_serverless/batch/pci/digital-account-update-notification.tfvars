...
ce_name = "digital-account-update-notification-compute-env-pci"
ce_cr_max_vcpus = 2
...
jq_name = "digital-account-update-notification-job-queue-pci"

jd_name = "digital-account-update-notification-job-definition-pci"
jd_timeout = 600
jd_container_command = ["accountupdatenotificationJob"]
jd_container_image = "601751840347.dkr.ecr.us-east-1.amazonaws.com/fmg-insuranceapps:digital-batch-account-update-pci"
...
schedule_job_name = "digital-account-update-notification-job-schedule-pci"