...
ce_name = "marketing-mb-enroll-failure-compute-env-pci"
ce_cr_max_vcpus = 2
...
jq_name = "marketing-mb-enroll-failure-job-queue-pci"

jd_name = "marketing-mb-enroll-failure-job-definition-pci"
jd_timeout = 600
jd_container_command = ["mbenrollemailfailureJob"]
jd_container_image = "601751840347.dkr.ecr.us-east-1.amazonaws.com/fmg-insuranceapps:marketing_mbenroll_failure_job-pci"
...
schedule_job_name = "marketing-mb-enroll-failure-job-schedule-pci"