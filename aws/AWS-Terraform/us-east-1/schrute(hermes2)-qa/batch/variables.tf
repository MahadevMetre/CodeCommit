variable "hermes_addr_standardization_bool" {
	type = bool
	default = false
}

variable "hermes_daily_aggregator_bool" {
	type = bool
	default = false
}

variable "hermes_email_aggregator_bool" {
	type = bool
	default = false
}

variable "hermes_file_processing_bool" {
	type = bool
	default = false
}

variable "hermes_kitcode_identification_bool" {
	type = bool
	default = false
}

variable "hermes_poe_image_processor_bool" {
	type = bool
	default = false
}

variable "hermes_post_processor_bool" {
	type = bool
	default = false
}

variable "hermes_preview_aggregator_bool" {
	type = bool
	default = false
}

variable "hermes_process_email_act_kitcode_bool" {
	type = bool
	default = false
}

variable "hermes_process_email_api_act_kitcode_bool" {
	type = bool
	default = false
}

variable "hermes_pycharm_batch_processor_xlarge_bool" {
	type = bool
	default = false
}

variable "hermes_pycharm_batch_processor_2xlarge_bool" {
	type = bool
	default = false
}

variable "hermes_pycharm_batch_processor_4xlarge_bool" {
	type = bool
	default = false
}

variable "hermes_pycharm_batch_processor_8xlarge_bool" {
	type = bool
	default = false
}

variable "hermes_regular_aggregator_bool" {
	type = bool
	default = false
}

variable "hermes_reprint_aggregator_bool" {
	type = bool
	default = false
}

variable "hermes_reprocessor_bool" {
	type = bool
	default = false
}

variable "hermes_transformer_bool" {
	type = bool
	default = false
}
