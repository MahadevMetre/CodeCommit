...
lambda_function_name = "hermes-email-analytics-stage"
role = "arn:aws:iam::702230634984:role/hermes-lambda-role-stage"
description = "Hermes Email Analytics Stage"
env_variables = {
	"EMAIL_ANALYTICS_URL"			= "https://stage-ecs.mtservices.franklinmadisonds.com/emailintegration/emailAnalytics"
}
tags = {
...
schedule_name = "hermes-email-analytics-schedule-stage"
schedule_target_role_arn = "arn:aws:iam::702230634984:role/hermes-ecs-task-execution-role-stage"

eb_rule_name = "hermes-email-analytics-rule-stage"
eb_rule_tags = {
	"ApplicationName"		= "Hermes2.0"
	"Automated"				= "True"
	"BackupPlan"			= "None"
