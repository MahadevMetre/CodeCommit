...
lambda_function_name = "hermes-kibana-count-api-qa"
role = "arn:aws:iam::634621569833:role/hermes-lambda-role-qa"
description = "Hermes Kibana Count API qa"
env_variables = {
	"API_URL"	= "https://qa-ecs.mtservices.franklinmadisonds.com/batchProcessor/kibanaCount"
}
tags = {
...
schedule_name = "hermes-kibana-count-api-schedule-qa"
