...
ce_name = "hermes-reprint-aggregator-compute-env-dev"
ce_cr_max_vcpus = 2
...
jq_name = "hermes-reprint-aggregator-job-queue-dev"

jd_name = "hermes-reprint-aggregator-job-definition-dev"
jd_timeout = 600
...
schedule_name = "hermes-reprint-aggregator-schedule-dev"
schedule_target_role_arn = "arn:aws:iam::116762271881:role/hermes-ecs-task-execution-role-dev"
schedule_job_name = "Hermes-RePrint-Aggregator-Job-Dev"