...
ce_name = "hermes-transformer-compute-env-dev"
ce_cr_max_vcpus = 4
...
jq_name = "hermes-transformer-job-queue-dev"

jd_name = "hermes-transformer-job-definition-dev"
jd_timeout = 600
...
eb_rule_name = "hermes-transformer-rule-dev"
eb_rule_tags = {
	"ApplicationName"		= "Hermes2.0"
	"Automated"				= "True"
	"BackupPlan"			= "None"
...
event_target_job_name = "Hermes-Transformer-Job-Dev"
