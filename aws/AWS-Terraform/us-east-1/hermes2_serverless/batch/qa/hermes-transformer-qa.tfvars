...
ce_name = "hermes-transformer-compute-env-qa"
ce_cr_max_vcpus = 4
...
jq_name = "hermes-transformer-job-queue-qa"

jd_name = "hermes-transformer-job-definition-qa"
jd_timeout = 600
...
eb_rule_name = "hermes-transformer-rule-qa"
eb_rule_tags = {
	"ApplicationName"		= "Hermes2.0"
	"Automated"				= "True"
	"BackupPlan"			= "None"
...
event_target_job_name = "Hermes-Transformer-Job-QA"
