...
ce_name = "hermes-kitcode-identification-compute-env-qa"
ce_cr_max_vcpus = 2
...
jq_name = "hermes-kitcode-identification-job-queue-qa"

jd_name = "hermes-kitcode-identification-job-definition-qa"
jd_timeout = 600
...
schedule_name = "hermes-kitcode-identification-schedule-qa"
schedule_target_role_arn = "arn:aws:iam::702230634984:role/hermes-ecs-task-execution-role-qa"
schedule_job_name = "Hermes-Kitcode-Identification-Job-QA"