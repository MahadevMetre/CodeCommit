...
ce_name = "hermes-transformer-compute-env-stage"
ce_cr_max_vcpus = 4
...
jq_name = "hermes-transformer-job-queue-stage"

jd_name = "hermes-transformer-job-definition-stage"
jd_timeout = 600
...
eb_rule_name = "hermes-transformer-rule-stage"
eb_rule_tags = {
	"ApplicationName"		= "Hermes2.0"
	"Automated"				= "True"
	"BackupPlan"			= "None"
...
event_target_job_name = "Hermes-Transformer-Job-Stage"
et_transformer_input_paths = {
	"S3BucketValue" = "$.detail.bucket.name",
	"S3KeyValue" = "$.detail.object.key"
}
et_transformer_input_template = "{\"Parameters\":{\"S3bucket\":\"<S3BucketValue>\",\"S3key\":\"<S3KeyValue>\"},\"ContainerOverrides\":{\"Environment\":[{\"Name\":\"DB_CONNECTION_POOL\",\"Value\":\"40\"},{\"Name\":\"LOG_LEVEL\",\"Value\":\"DEBUG\"},{\"Name\":\"PYCHARM_DOCKER_BATCH_WAY\",\"Value\":\"TRUE\"}]}}"
