hermes_preview_aggregator_bool = true
ce_name = "hermes-preview-aggregator-compute-env-stage"
ce_cr_max_vcpus = 2
...
jq_name = "hermes-preview-aggregator-job-queue-stage"

jd_name = "hermes-preview-aggregator-job-definition-stage"
jd_timeout = 600
jd_container_command = ["preview_aggregatorJob"]
...
schedule_name = "hermes-preview-aggregator-schedule-stage"
schedule_target_role_arn = "arn:aws:iam::702230634984:role/hermes-ecs-task-execution-role-stage"
schedule_job_name = "Hermes-Preview-Aggregator-Job-Stage"