...
ce_name = "hermes-process-email-api-act-kitcode-compute-env-stage"
ce_cr_max_vcpus = 2
...
jq_name = "hermes-process-email-api-act-kitcode-job-queue-stage"

jd_name = "hermes-process-email-api-act-kitcode-job-definition-stage"
jd_timeout = 1200
...
schedule_name = "hermes-process-email-api-act-kitcode-schedule-stage"
schedule_target_role_arn = "arn:aws:iam::702230634984:role/hermes-ecs-task-execution-role-stage"
schedule_job_name = "Hermes-Process-Email-API-Act-Kitcode-Job-Stage"