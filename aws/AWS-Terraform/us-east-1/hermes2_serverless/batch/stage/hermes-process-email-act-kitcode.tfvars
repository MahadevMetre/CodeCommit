...
ce_name = "hermes-process-email-act-kitcode-compute-env-stage"
ce_cr_max_vcpus = 2
...
ce_tags = {
	...
	"LastUpdated"			= "11092023"
	"TechStack"				= "AWS"
	"Usage"					= "Project"
	"Version"				= "1.0"
}

jq_name = "hermes-process-email-act-kitcode-job-queue-stage"

jd_name = "hermes-process-email-act-kitcode-job-definition-stage"
jd_timeout = 600
...
schedule_name = "hermes-process-email-act-kitcode-schedule-stage"
schedule_target_role_arn = "arn:aws:iam::702230634984:role/hermes-ecs-task-execution-role-stage"
schedule_job_name = "Hermes-Process-Email-Act-Kitcode-Job-Stage"