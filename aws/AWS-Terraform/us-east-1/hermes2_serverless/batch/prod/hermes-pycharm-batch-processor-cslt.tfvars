...
ce_cr_tags = {
	...
	"CreatedBy"				= "hermes-pycharm-batch-processor-cslt-compute-env-prod"
	"DataClassification"	= "None"
	"Department"			= "HMS2"
	"Infrastructure"		= "False"
	"Name"					= "Hermes-PyCharm-Batch-Processor-CSLT-EC2-Prod"
	"TechStack"				= "AWS"
	"Usage"					= "Project"
	"Version"				= "1.0"
}
...
ce_name_xlarge = "hermes-pycharm-batch-processor-cslt-xlarge-compute-env-prod"
ce_cr_instance_type_xlarge = ["c7i.xlarge"]
ce_cr_max_vcpus_xlarge = 4
jq_name_xlarge = "hermes-pycharm-batch-processor-cslt-xlarge-job-queue-prod"
jd_name_xlarge = "hermes-pycharm-batch-processor-cslt-xlarge-job-definition-prod"
jd_timeout_xlarge = 1200
jd_container_vcpu_xlarge = "4"
jd_container_memory_xlarge = "7424"
eb_rule_name_xlarge = "hermes-pycharm-batch-processor-cslt-xlarge-rule-prod"
...
event_target_job_name_xlarge = "Hermes-PyCharm-Batch-Processor-CSLT-XLarge-Job-Prod"
// End pycharm-batch-processor-cslt-xlarge config
// Begin pycharm-batch-processor-cslt-2xlarge config
ce_name_2xlarge = "hermes-pycharm-batch-processor-cslt-2xlarge-compute-env-prod"
ce_cr_instance_type_2xlarge = ["c7i.2xlarge"]
ce_cr_max_vcpus_2xlarge = 8
jq_name_2xlarge = "hermes-pycharm-batch-processor-cslt-2xlarge-job-queue-prod"
jd_name_2xlarge = "hermes-pycharm-batch-processor-cslt-2xlarge-job-definition-prod"
jd_timeout_2xlarge = 1800
jd_container_vcpu_2xlarge = "8"
jd_container_memory_2xlarge = "14848"
eb_rule_name_2xlarge = "hermes-pycharm-batch-processor-cslt-2xlarge-rule-prod"
...
event_target_job_name_2xlarge = "Hermes-PyCharm-Batch-Processor-CSLT-2XLarge-Job-Prod"
// End pycharm-batch-processor-cslt-2xlarge config
// Begin pycharm-batch-processor-cslt-4xlarge config
ce_name_4xlarge = "hermes-pycharm-batch-processor-cslt-4xlarge-compute-env-prod"
ce_cr_instance_type_4xlarge = ["c7i.4xlarge"]
ce_cr_max_vcpus_4xlarge = 16
jq_name_4xlarge = "hermes-pycharm-batch-processor-cslt-4xlarge-job-queue-prod"
jd_name_4xlarge = "hermes-pycharm-batch-processor-cslt-4xlarge-job-definition-prod"
jd_timeout_4xlarge = 3000
jd_container_vcpu_4xlarge = "16"
jd_container_memory_4xlarge = "29696"
eb_rule_name_4xlarge = "hermes-pycharm-batch-processor-cslt-4xlarge-rule-prod"
...
event_target_job_name_4xlarge = "Hermes-PyCharm-Batch-Processor-CSLT-4XLarge-Job-Prod"
// End pycharm-batch-processor-cslt-4xlarge config
// Begin pycharm-batch-processor-cslt-8xlarge config
ce_name_8xlarge = "hermes-pycharm-batch-processor-cslt-8xlarge-compute-env-prod"
ce_cr_instance_type_8xlarge = ["c7i.8xlarge"]
ce_cr_max_vcpus_8xlarge = 32
jq_name_8xlarge = "hermes-pycharm-batch-processor-cslt-8xlarge-job-queue-prod"
jd_name_8xlarge = "hermes-pycharm-batch-processor-cslt-8xlarge-job-definition-prod"
jd_timeout_8xlarge = 4800
jd_container_vcpu_8xlarge = "32"
jd_container_memory_8xlarge = "59392"
eb_rule_name_8xlarge = "hermes-pycharm-batch-processor-cslt-8xlarge-rule-prod"
...
event_target_job_name_8xlarge = "Hermes-PyCharm-Batch-Processor-CSLT-8XLarge-Job-Prod"
