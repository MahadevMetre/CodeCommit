...
ce_name = "hermes-transformer-compute-env-prod"
ce_cr_max_vcpus = 8
...
jq_name = "hermes-transformer-job-queue-prod"

jd_name = "hermes-transformer-job-definition-prod"
jd_timeout = 600
...
eb_rule_name = "hermes-transformer-rule-prod"
eb_rule_tags = {
	"ApplicationName"		= "Hermes2.0"
	"Automated"				= "True"
	"BackupPlan"			= "None"
...
event_target_job_name = "Hermes-Transformer-Job-Prod"
