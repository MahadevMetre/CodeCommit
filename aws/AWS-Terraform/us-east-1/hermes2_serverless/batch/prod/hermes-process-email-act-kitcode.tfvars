...
ce_name = "hermes-process-email-act-kitcode-compute-env-prod"
ce_cr_max_vcpus = 2
...
jq_name = "hermes-process-email-act-kitcode-job-queue-prod"

jd_name = "hermes-process-email-act-kitcode-job-definition-prod"
jd_timeout = 600
...
schedule_name = "hermes-process-email-act-kitcode-schedule-prod"
schedule_target_role_arn = "arn:aws:iam::361469336240:role/hermes-ecs-task-execution-role-prod"
schedule_job_name = "Hermes-Process-Email-Act-Kitcode-Job-Prod"