...
sqs_queue_name = "hermes2-email-ISG-EICP-dev.fifo"
...
eb_rule_name = "hermes-email-transformer-ISG-EICP-api-rule-dev"
eb_rule_tags = {
	"ApplicationName"		= "Hermes2.0"
	"Automated"				= "True"
	"BackupPlan"			= "None"
...
eb_rule_event_pattern = {
	detail = {
		...
		object = {
			key = [
				{
					prefix = "transformer/email/EICP/ISG/incoming/"
				}
			]
		}
	}
