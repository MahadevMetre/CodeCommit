alb_sg_name					= "fmg-ecs-sg-alb-dev"
...
lb_name						= "fmg-serverless-alb-dev"
lb_type						= "application"
lb_tags = {
	"ApplicationName"		= "Hermes2.0"
	"Automated"				= "True"
...
tg2_name							= "pycharm-webservices-tg-dev"
tg2_health_check_port				= 80
tg2_protocol						= "HTTP"
tg2_vpc_id							= "vpc-00ff8e33839358d28"
...
tg3_name							= "fmg-serverless-email-tg-dev"
tg3_health_check_port				= 8080
tg3_protocol						= "HTTP"
tg3_vpc_id							= "vpc-00ff8e33839358d28"
...
lbl_certificate_arn					= "arn:aws:acm:us-east-1:116762271881:certificate/8824b0c7-1609-41d5-8947-03247922a45e"
...
route53_name				= "dev-ecs.mtservices.franklinmadisonds.com"
route53_type				= "CNAME"