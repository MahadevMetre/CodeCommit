config_set_name = "digital-email-tracking-stage"
config_set_tags = {
...
event_dest_name = "digital-email-tracking-firehose-stage"
event_types = ["CLICK", "DELIVERY", "OPEN"]

log_group_name = "/aws/kinesisfirehose/PUT-digital-email-tracking-stage"
log_retention_days = "30"

bucket_short_name = "digital-email-tracking"
environment = "stage"
logging_bucket_name = "franklin-stage-s3-access-logs"
logging_bucket_base_prefix = "digital-email-tracking-stage"
acl = "private"
s3b_tags ={
    "ApplicationName"		= "Digital"
	"Automated"				= "True"
...
fs_stream_name = "PUT-digital-email-tracking-stage"
...
ext_s3_config_buffering_interval = 300
...
role_name		= "digital-email-tracking-role-stage"
...
iam_policy_name					= "digital-email-tracking-policy-stage"
iam_policy_tags					= {
	"ApplicationName": "Digital",
	"Automated": "True",
	"BackupPlan": "None",
...
lambda_role = "arn:aws:iam::702230634984:role/fmg-dw-lambda-role"
lambda_description = "Function to transform Firehose stream event to nested json."
lambda_env_variables = {
	"bucket_name"	= "fmg-dw-s3-datalake-qa"
