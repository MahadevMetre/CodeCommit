config_set_name = "digital-email-tracking-dev"
config_set_tags = {
...
event_dest_name = "digital-email-tracking-firehose-dev"
event_types = ["CLICK", "DELIVERY", "OPEN"]

log_group_name = "/aws/kinesisfirehose/PUT-digital-email-tracking-dev"
log_retention_days = "30"

bucket_short_name = "digital-email-tracking"
environment = "dev"
logging_bucket_name = "franklin-dev-s3-access-logs"
logging_bucket_base_prefix = "digital-email-tracking-dev"
acl = "private"
s3b_tags ={
    "ApplicationName"		= "Digital"
	"Automated"				= "True"
...
fs_stream_name = "PUT-digital-email-tracking-dev"
...
role_name		= "digital-email-tracking-role-dev"
...
iam_policy_name					= "digital-email-tracking-policy-dev"
iam_policy_tags					= {
	"ApplicationName": "Digital",
	"Automated": "True",
	"BackupPlan": "None",
...
lambda_role = "arn:aws:iam::116762271881:role/fmg-dw-lambda-role"
lambda_description = "Function to transform Firehose stream event to nested json."
lambda_env_variables = {
	"bucket_name"	= "fmg-dw-s3-datalake-dev"
