...
sqs_queue_name = "hermes2-email-preview-addr-incoming-stage.fifo"
...
eb_rule_name = "hermes-email-transformer-preview-addr-api-rule-stage"
eb_rule_tags = {
	"ApplicationName"		= "Hermes2.0"
	"Automated"				= "True"
	"BackupPlan"			= "None"
...
eb_rule_event_pattern = {
	detail = {
		...
		object = {
			key = [
				{
					prefix = "transformer/email/preview_address_standardization/incoming/"
				}
			]
		}
	}
