hermes_reprocessor_bool = true
ce_name = "hermes-reprocessor-compute-env-stage"
ce_cr_max_vcpus = 2
...
jq_name = "hermes-reprocessor-job-queue-stage"

jd_name = "hermes-reprocessor-job-definition-stage"
jd_timeout = 1200
jd_container_command = ["reProcessorJob1"]
...
schedule_name = "hermes-reprocessor-schedule-stage"
schedule_target_role_arn = "arn:aws:iam::702230634984:role/hermes-ecs-task-execution-role-stage"
schedule_job_name = "Hermes-Reprocessor-Job-Stage"