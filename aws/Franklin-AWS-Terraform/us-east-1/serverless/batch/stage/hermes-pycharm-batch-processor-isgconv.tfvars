...
ce_cr_tags = {
	...
	"CreatedBy"				= "hermes-pycharm-batch-processor-isgconv-compute-env-stage"
	"DataClassification"	= "None"
	"Department"			= "HMS2"
	"Infrastructure"		= "False"
	"Name"					= "Hermes-PyCharm-Batch-Processor-ISGCONV-EC2-Stage"
	"TechStack"				= "AWS"
	"Usage"					= "Project"
	"Version"				= "1.0"
}
...
// Begin pycharm-batch-processor-isgconv-xlarge config
ce_name_xlarge = "hermes-pycharm-batch-processor-isgconv-xlarge-compute-env-stage"
ce_cr_instance_type_xlarge = ["c7i.xlarge"]
ce_cr_max_vcpus_xlarge = 4
jq_name_xlarge = "hermes-pycharm-batch-processor-isgconv-xlarge-job-queue-stage"
jd_name_xlarge = "hermes-pycharm-batch-processor-isgconv-xlarge-job-definition-stage"
jd_timeout_xlarge = 1200
jd_container_vcpu_xlarge = "4"
jd_container_memory_xlarge = "7424"
eb_rule_name_xlarge = "hermes-pycharm-batch-processor-isgconv-xlarge-rule-stage"
eb_rule_event_pattern_xlarge = {
	detail = {
		...
		object = {
			key = [
				{
					prefix = "hermes2/pycharm_incoming/incoming/isgconv/800/"
				}
			]
		}
	}
...
event_target_job_name_xlarge = "Hermes-PyCharm-Batch-Processor-ISGCONV-XLarge-Job-Stage"
// End pycharm-batch-processor-isgconv-xlarge config
// Begin pycharm-batch-processor-isgconv-2xlarge config
ce_name_2xlarge = "hermes-pycharm-batch-processor-isgconv-2xlarge-compute-env-stage"
ce_cr_instance_type_2xlarge = ["c7i.2xlarge"]
ce_cr_max_vcpus_2xlarge = 8
jq_name_2xlarge = "hermes-pycharm-batch-processor-isgconv-2xlarge-job-queue-stage"
jd_name_2xlarge = "hermes-pycharm-batch-processor-isgconv-2xlarge-job-definition-stage"
jd_timeout_2xlarge = 1800
jd_container_vcpu_2xlarge = "8"
jd_container_memory_2xlarge = "14848"
eb_rule_name_2xlarge = "hermes-pycharm-batch-processor-isgconv-2xlarge-rule-stage"
eb_rule_event_pattern_2xlarge = {
	detail = {
		...
		object = {
			key = [
				{
					prefix = "hermes2/pycharm_incoming/incoming/isgconv/1600/"
				}
			]
		}
	}
...
event_target_job_name_2xlarge = "Hermes-PyCharm-Batch-Processor-ISGCONV-2XLarge-Job-Stage"
// End pycharm-batch-processor-isgconv-2xlarge config
// Begin pycharm-batch-processor-isgconv-4xlarge config
ce_name_4xlarge = "hermes-pycharm-batch-processor-isgconv-4xlarge-compute-env-stage"
ce_cr_instance_type_4xlarge = ["c7i.4xlarge"]
ce_cr_max_vcpus_4xlarge = 16
jq_name_4xlarge = "hermes-pycharm-batch-processor-isgconv-4xlarge-job-queue-stage"
jd_name_4xlarge = "hermes-pycharm-batch-processor-isgconv-4xlarge-job-definition-stage"
jd_timeout_4xlarge = 3000
jd_container_vcpu_4xlarge = "16"
jd_container_memory_4xlarge = "29696"
eb_rule_name_4xlarge = "hermes-pycharm-batch-processor-isgconv-4xlarge-rule-stage"
eb_rule_event_pattern_4xlarge = {
	detail = {
		...
		object = {
			key = [
				{
					prefix = "hermes2/pycharm_incoming/incoming/isgconv/3200/"
				}
			]
		}
	}
...
event_target_job_name_4xlarge = "Hermes-PyCharm-Batch-Processor-ISGCONV-4XLarge-Job-Stage"
// End pycharm-batch-processor-isgconv-4xlarge config
// Begin pycharm-batch-processor-isgconv-8xlarge config
ce_name_8xlarge = "hermes-pycharm-batch-processor-isgconv-8xlarge-compute-env-stage"
ce_cr_instance_type_8xlarge = ["c7i.8xlarge"]
ce_cr_max_vcpus_8xlarge = 32
jq_name_8xlarge = "hermes-pycharm-batch-processor-isgconv-8xlarge-job-queue-stage"
jd_name_8xlarge = "hermes-pycharm-batch-processor-isgconv-8xlarge-job-definition-stage"
jd_timeout_8xlarge = 4800
jd_container_vcpu_8xlarge = "32"
jd_container_memory_8xlarge = "59392"
eb_rule_name_8xlarge = "hermes-pycharm-batch-processor-isgconv-8xlarge-rule-stage"
eb_rule_event_pattern_8xlarge = {
	detail = {
		...
		object = {
			key = [
				{
					prefix = "hermes2/pycharm_incoming/incoming/isgconv/6400/"
				}
			]
		}
	}
...
event_target_job_name_8xlarge = "Hermes-PyCharm-Batch-Processor-ISGCONV-8XLarge-Job-Stage"
// End pycharm-batch-processor-isgconv-8xlarge config