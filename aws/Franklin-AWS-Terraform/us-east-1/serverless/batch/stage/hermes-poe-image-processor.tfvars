...
ce_name = "hermes-poe-image-processor-compute-env-stage"
ce_cr_max_vcpus = 2
...
jq_name = "hermes-poe-image-processor-job-queue-stage"

jd_name = "hermes-poe-image-processor-job-definition-stage"
jd_timeout = 900
...
schedule_name = "hermes-poe-image-processor-schedule-stage"
schedule_target_role_arn = "arn:aws:iam::702230634984:role/hermes-ecs-task-execution-role-stage"
schedule_job_name = "Hermes-POE-Image-Processor-Job-Stage"