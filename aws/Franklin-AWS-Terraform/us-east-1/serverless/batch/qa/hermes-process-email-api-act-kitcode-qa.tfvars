...
ce_name = "hermes-process-email-api-act-kitcode-compute-env-qa"
ce_cr_max_vcpus = 2
...
jq_name = "hermes-process-email-api-act-kitcode-job-queue-qa"

jd_name = "hermes-process-email-api-act-kitcode-job-definition-qa"
jd_timeout = 1200
...
schedule_name = "hermes-process-email-api-act-kitcode-schedule-qa"
schedule_target_role_arn = "arn:aws:iam::702230634984:role/hermes-ecs-task-execution-role-qa"
schedule_job_name = "Hermes-Process-Email-API-Act-Kitcode-Job-QA"