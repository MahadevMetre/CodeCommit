...
ce_name = "hermes-process-email-act-kitcode-compute-env-dev"
ce_cr_max_vcpus = 2
...
jq_name = "hermes-process-email-act-kitcode-job-queue-dev"

jd_name = "hermes-process-email-act-kitcode-job-definition-dev"
jd_timeout = 600
...
schedule_name = "hermes-process-email-act-kitcode-schedule-dev"
schedule_target_role_arn = "arn:aws:iam::116762271881:role/hermes-ecs-task-execution-role-dev"
schedule_job_name = "Hermes-Process-Email-Act-Kitcode-Job-Dev"