...
ce_name = "hermes-reprocessor-compute-env-dev"
ce_cr_max_vcpus = 2
...
jq_name = "hermes-reprocessor-job-queue-dev"

jd_name = "hermes-reprocessor-job-definition-dev"
jd_timeout = 1200
...
schedule_name = "hermes-reprocessor-schedule-dev"
schedule_target_role_arn = "arn:aws:iam::116762271881:role/hermes-ecs-task-execution-role-dev"
schedule_job_name = "Hermes-Reprocessor-Job-Dev"