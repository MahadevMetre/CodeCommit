...
ce_name = "hermes-preview-aggregator-compute-env-prod"
ce_cr_max_vcpus = 2
...
jq_name = "hermes-preview-aggregator-job-queue-prod"

jd_name = "hermes-preview-aggregator-job-definition-prod"
jd_timeout = 600
...
schedule_name = "hermes-preview-aggregator-schedule-prod"
schedule_target_role_arn = "arn:aws:iam::361469336240:role/hermes-ecs-task-execution-role-prod"
schedule_job_name = "Hermes-Preview-Aggregator-Job-Prod"