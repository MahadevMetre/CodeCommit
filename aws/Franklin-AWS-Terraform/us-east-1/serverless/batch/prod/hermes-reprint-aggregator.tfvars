...
ce_name = "hermes-reprint-aggregator-compute-env-prod"
ce_cr_max_vcpus = 2
...
jq_name = "hermes-reprint-aggregator-job-queue-prod"

jd_name = "hermes-reprint-aggregator-job-definition-prod"
jd_timeout = 600
...
schedule_name = "hermes-reprint-aggregator-schedule-prod"
schedule_target_role_arn = "arn:aws:iam::361469336240:role/hermes-ecs-task-execution-role-prod"
schedule_job_name = "Hermes-RePrint-Aggregator-Job-Prod"