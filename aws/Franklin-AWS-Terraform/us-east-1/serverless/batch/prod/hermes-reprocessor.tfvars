...
ce_name = "hermes-reprocessor-compute-env-prod"
ce_cr_max_vcpus = 2
...
jq_name = "hermes-reprocessor-job-queue-prod"

jd_name = "hermes-reprocessor-job-definition-prod"
jd_timeout = 1200
...
schedule_name = "hermes-reprocessor-schedule-prod"
schedule_target_role_arn = "arn:aws:iam::361469336240:role/hermes-ecs-task-execution-role-prod"
schedule_job_name = "Hermes-Reprocessor-Job-Prod"