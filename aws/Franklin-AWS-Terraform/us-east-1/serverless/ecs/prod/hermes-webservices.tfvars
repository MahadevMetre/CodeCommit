cluster_name				= "hermes-webservices-prod"
cluster_tags = {
...
iam_role_name				= "hermes-ecs-task-execution-role-prod"
...
cloudwatch_log_group_name	= "/ecs/hermes-webservices-prod"
...
task_definition_family		= "hermes-webservices-api-task-prod"
container_definition_name	= "hermes-webservices-container"
container_definition_image	= "361469336240.dkr.ecr.us-east-1.amazonaws.com/fmg-insuranceapps:hermes-web-services-prod"
...
service_name				= "hermes-webservices-api-service-prod"

service_subnets				= ["subnet-0052ab706c1f947c9", "subnet-011ed7a9e6d735228"]
service_sg					= ["sg-03e2f86c64383bf88"]
service_tg_arn				= "arn:aws:elasticloadbalancing:us-east-1:361469336240:targetgroup/fmg-serverless-tg-prod/012449af7259bd29"