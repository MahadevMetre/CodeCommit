...
allowed_api_user_list        = ["arn:aws:iam::894891841990:user/AthenaNextGen-billing-s3-Api-User-Prod"]
s3_vpc_endpoint = []
allowed_read_only_user_list       = ["arn:aws:iam::894891841990:user/AthenaNextGen-billing-s3-Biz-User-Prod"]
...
status                              = "Enabled"
replication_id                      = "athenanextgen-billing-replication"
s3_destination_arn                  = "arn:aws:s3:::athenanextgen-billing-dr"