...
ebs_tags = {
	...
	"InstanceID"			= "i-0ec9c512b0aca4bf4"
...
private_ip        =     "10.153.30.115"

#Security Group
sg_name				= "insuranceapps-jboss-admin-sg-pci"
...
sg_tags				= {
	...
	"Name"					= "insuranceapps-jboss-admin-sg-pci"
	"TechStack"				= "AWS"
	"Usage"					= "Project"
	"Version"				= "1.0"
}
  ...
  "33" = {
    ...
    description = "CrushFTP Primary Server 1"
  },
  "34" = {
    from_port   = 22
    to_port     = 22
    ...
    description = "CrushFTP Secondary Server 2"
  },
  "35" = {
    from_port   = 446
    to_port     = 446
    ...
    description = "PRODCBU7 (input by clafontant)"
  },
  "36" = {
    from_port   = 22
    to_port     = 22
    protocol    = "tcp"
	cidr_blocks = ["10.245.212.125/32"]
    description = "SSH for PRODCBU7 (input by clafontant)"
  },
  "37" = {
    from_port   = 443
    to_port     = 443
