...
allowed_ins_users_iam_arn_list = ["arn:aws:iam::894891841990:user/InsCabinetHistoric-S3-Api-User-PCI"]
...
lifecycle_rule = [
  {
      enabled = true
      id = "lifecycle-rule-2020-365d"
      prefix = "HISTORIC/2020/"
      transition = [
        {
          days = 365
    ...
    {
      enabled = true
      id = "lifecycle-rule-2019-365d"
      prefix = "HISTORIC/2019/"
      transition = [
        {
          days = 365
          storage_class = "GLACIER"
