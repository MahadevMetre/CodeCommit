...
logging_bucket_base_prefix = "lasso-scanned-files-qa"
acl                 = "private"
tags ={
...
lambda_event_triggers = {
	"1" = {
		lambda_notification_function_arn = "arn:aws:lambda:us-east-1:702230634984:function:lasso-induct-batch-qa"
	...
	"3" = {
		lambda_notification_function_arn = "arn:aws:lambda:us-east-1:702230634984:function:lasso-induct-batch-claims-qa"
		events = ["s3:ObjectCreated:Put", "s3:ObjectCreated:Copy", "s3:ObjectCreated:CompleteMultipartUpload"]
	...
	"4" = {
		lambda_notification_function_arn = "arn:aws:lambda:us-east-1:702230634984:function:lasso-scanned-ips-report-qa"
		events = ["s3:ObjectCreated:Put", "s3:ObjectCreated:Copy", "s3:ObjectCreated:CompleteMultipartUpload"]
