...
logging_bucket_base_prefix = "lasso-claims-tracker-files-qa"
acl                 = "private"
tags ={
...
lambda_event_triggers = {
	"1" = {
		lambda_notification_function_arn = "arn:aws:lambda:us-east-1:702230634984:function:lasso-claims-tracker-induction-qa"
