lambda_function_name = "lasso-claims-tracker-induction-qa"
role = "arn:aws:iam::702230634984:role/lasso-lambda-role-stage"
description = "Lasso Claims Tracker Induction QA"
env_variables = {
...
s3_bucket_statement_id = "event_permissions_for_bucket_lasso-claims-tracker-files-qa"
s3_bucket_account_id = "702230634984"
s3_bucket_arn = "arn:aws:s3:::lasso-claims-tracker-files-qa"