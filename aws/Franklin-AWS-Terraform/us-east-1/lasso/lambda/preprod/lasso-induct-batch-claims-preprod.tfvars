lambda_function_name = "lasso-induct-batch-claims-preprod"
role = "arn:aws:iam::702230634984:role/lasso-lambda-role-stage"
description = "Lasso Induct Batch Claims PreProd"
env_variables = {
		...
		"S3_ERROR_DIR"					=	"_ERROR"
		"S3_LASSO_BATCH_FILES"			=	"lasso-batch-files-preprod"
...
s3_bucket_statement_id = "event_permissions_for_bucket_lasso-scanned-files-preprod"
s3_bucket_account_id = "702230634984"
s3_bucket_arn = "arn:aws:s3:::lasso-scanned-files-preprod"