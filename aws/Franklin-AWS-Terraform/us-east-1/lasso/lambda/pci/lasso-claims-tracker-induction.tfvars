lambda_function_name = "lasso-claims-tracker-induction-pci"
role = "arn:aws:iam::601751840347:role/lasso-lambda-role-pci"
description = "Lasso Claims Tracker Induction PCI"
env_variables = {
...
s3_bucket_statement_id = "event_permissions_for_bucket_lasso-claims-tracker-files-pci"
s3_bucket_account_id = "601751840347"
s3_bucket_arn = "arn:aws:s3:::lasso-claims-tracker-files-pci"