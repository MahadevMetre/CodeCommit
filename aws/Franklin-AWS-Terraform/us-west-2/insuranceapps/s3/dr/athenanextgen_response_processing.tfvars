...
allowed_api_user_list        = ["arn:aws:iam::894891841990:user/AthenaNextGen-respproc-s3-Api-User-DR"]
s3_vpc_endpoint = []
allowed_read_only_user_list       = ["arn:aws:iam::894891841990:user/AthenaNextGen-respproc-s3-Biz-User-DR"]
