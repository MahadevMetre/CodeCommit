...
lambda_function_name = "hermes-payload-cleanup-api-dr"
role = "arn:aws:iam::214946096060:role/hermes-lambda-role-dr"
description = "Hermes Payload Cleanup API DR"
env_variables = {
	"API_URL"	= "https://dr-ecs.mtservices.franklinmadisonds.com/batchProcessor/removePayload"
}
tags = {
...
schedule_name = "hermes-payload-cleanup-api-schedule-dr"
