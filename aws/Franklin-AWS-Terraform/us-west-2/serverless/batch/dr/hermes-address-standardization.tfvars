...
ce_name = "hermes-address-standardization-compute-env-dr"
ce_cr_max_vcpus = 8
...
jq_name = "hermes-address-standardization-job-queue-dr"

jd_name = "hermes-address-standardization-job-definition-dr"
jd_timeout = 600
...
eb_rule_name = "hermes-address-standardization-rule-dr"
eb_rule_tags = {
	"ApplicationName"		= "Hermes2.0"
	"Automated"				= "True"
	"BackupPlan"			= "None"
...
event_target_job_name = "Hermes-Address-Standardization-Job-DR"
