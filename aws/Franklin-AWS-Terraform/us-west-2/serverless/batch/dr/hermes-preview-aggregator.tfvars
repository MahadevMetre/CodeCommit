...
ce_name = "hermes-preview-aggregator-compute-env-dr"
ce_cr_max_vcpus = 2
...
jq_name = "hermes-preview-aggregator-job-queue-dr"

jd_name = "hermes-preview-aggregator-job-definition-dr"
jd_timeout = 600
...
schedule_name = "hermes-preview-aggregator-schedule-dr"
schedule_target_role_arn = "arn:aws:iam::214946096060:role/hermes-ecs-task-execution-role-dr"
schedule_job_name = "Hermes-Preview-Aggregator-Job-DR"