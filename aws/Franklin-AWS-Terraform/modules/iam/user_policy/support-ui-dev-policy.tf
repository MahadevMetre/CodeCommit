resource "aws_iam_policy" "support_ui_dev_policy" {
    ...
    "Statement" : [
      {
        ...
        "Resource" : [
          "arn:aws:codecommit:${var.region}:${var.account_id}:${var.repository_name}/hermes2/ui/*",
          "arn:aws:codecommit:${var.region}:${var.account_id}:${var.repository_name}/athenanextgen/ui/*"
        ]
      },
      {
        "Effect" : "Deny",
